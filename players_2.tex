...
\usepackage{tikz}
\usepackage[paperwidth=26cm, paperheight=9cm, margin=0.5cm]{geometry}
\pagestyle{empty}
...
\expandafter\def\csname Qrow25\endcsname{0/0/0/0}
...
\draw (-6.5, 0.0) -- (6.5, 0.0);

    \player{-3.0}{#1}{#2}
    \player{ 3.0}{#3}{#4}

    \ifnum#5>0
      \pgfmathsetmacro{\startA}{-3.0 - (#5-1)*0.80/2}
      \foreach \i in {1,...,#5}{
    ...
    \fi
    \ifnum#6>0
      \pgfmathsetmacro{\startB}{3.0 - (#6-1)*0.80/2}
      \foreach \i in {1,...,#6}{
